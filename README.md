...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Cosmic-Bug/Streamer)

 
## Deploy to VPS

```sh
git clone https://github.com/Cosmic-Bug/Streamer
cd Streamer
